...
namespace CashRecycler.CashRecyclerTemplate
{
    ...
    /// </summary>
    public class CashRecyclerTemplate : ICashManagementDevice, ICashDispenserDevice, ICashAcceptorDevice, ICommonDevice, IStorageDevice
    {
        /// <summary>
        /// RunAync
        ...
        public CashRecyclerTemplate(XFS4IoT.ILogger Logger)
        {
            Logger.IsNotNull($"Invalid parameter received in the {nameof(CashRecyclerTemplate)} constructor. {nameof(Logger)}");
            this.Logger = Logger;
        ...
        private CashManagementStatusClass.PositionStatusClass positionStatus = 
