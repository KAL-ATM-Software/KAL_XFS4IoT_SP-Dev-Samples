    ...
    class Server
    {
        static async Task Main(/*string[] args*/)
        {
            ...
            try
            {
                ...
                /// Check scanner Service Provider
                var checkScannerDevice = new CheckScannerTemplate(Logger);
                var checkScannerService = new CheckScannerServiceProvider(EndpointDetails,
                                                                          ServiceName: "CheckScannerTemplate",
                                                                          checkScannerDevice,
                                                                          Logger,
                                                                          new FilePersistentData(Logger));

                checkScannerDevice.SetServiceProvider = checkScannerService;
                Publisher.Add(checkScannerService);
