...
namespace VendorMode.VendorModeTemplate
{
    /// <summary>
    /// Sample VendorMode device class to implement
    /// </summary>
    public class VendorModeTemplate : IVendorModeDevice, ICommonDevice
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="Logger"></param>
        public VendorModeTemplate(ILogger Logger)
        {
            Logger.IsNotNull($"Invalid parameter received in the {nameof(VendorModeTemplate)} constructor. {nameof(Logger)}");
            this.Logger = Logger;
        }
