...
namespace IBNS.IBNSTemplate
{
    /// <summary>
    /// Sample indipendent IBNS device class to implement
    /// </summary>
    public class IBNSTemplate : IBanknoteNeutralizationDevice, ICommonDevice, IStorageDevice
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="Logger"></param>
        public IBNSTemplate(ILogger Logger)
        {
            Logger.IsNotNull($"Invalid parameter received in the {nameof(IBNSTemplate)} constructor. {nameof(Logger)}");
            this.Logger = Logger;
        ...
        /// </summary>
        public Task<SetProtectionResult> SetProtectionAsync(SetProtectionRequest request, CancellationToken cancellation)
        {
        ...
        /// </summary>
        public Task<TriggerNeutralizationResult> TriggerNeutralizationAsync(TriggerNeutralizationRequest request, CancellationToken cancellation)
        {
            throw new NotImplementedException();
        }
        ...
        {
            /* <onitor sensors and update status in this routine
