    ...
    class Server
    {
        static async Task Main(/*string[] args*/)
        {
            ...
            try
            {
                ...
                var simCardReaderDeviceSync = new CardReaderSample(Logger);
                var simCardReaderDevice = new CardReaderWrapper(simCardReaderDeviceSync, simCardReaderDeviceSync, Logger);
