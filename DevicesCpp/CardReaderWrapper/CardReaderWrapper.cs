...
namespace KAL.XFS4IoTSP.CardReader.Sample
{
    ...
    /// </summary>
    public class CardReaderWrapper : ICardReaderDevice, ICommonDevice 
    {
        private readonly ICardReaderDeviceSync CardReader;
        private readonly ICommonDeviceSync Common; 

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="Logger"></param>
        public CardReaderWrapper(ICardReaderDeviceSync CardReader, ICommonDeviceSync Common, ILogger Logger)
        {
            this.CardReader = CardReader ?? throw new System.ArgumentNullException(nameof(CardReader));
            this.Common = Common ?? throw new System.ArgumentNullException(nameof(Common));
        }
        ...
        public async Task<AcceptCardResult> AcceptCardAsync(IAcceptCardEvents events,
            ...
            => await Task.Run(() => CardReader.AcceptCardSync(events, acceptCardInfo, cancellation));
        ...
        public async Task<ReadCardResult> ReadCardAsync(IReadRawDataEvents events,
                                                        ...
                                                        CancellationToken cancellation)
            => await Task.Run(() => CardReader.ReadCardSync(events, dataToRead, cancellation));
        ...
        public async Task<WriteCardResult> WriteCardAsync(IWriteRawDataEvents events,
                                                          ...
                                                          CancellationToken cancellation)
            => await Task.Run(() => CardReader.WriteCardSync(events, dataToWrite, cancellation));
        ...
        public async Task<EjectCardResult> EjectCardAsync(EjectCardRequest ejectCardInfo,
                                                          CancellationToken cancellation)
            => await Task.Run(() => CardReader.EjectCardSync(ejectCardInfo, cancellation));
        ...
        public async Task<ChipIOResult> ChipIOAsync(ChipIORequest dataToSend,
                                                    CancellationToken cancellation)
            => await Task.Run(() => CardReader.ChipIOSync(dataToSend, cancellation));
        ...
        public async Task<ResetDeviceResult> ResetDeviceAsync(IResetEvents events,
                                                              ...
                                                              CancellationToken cancellation)
            => await Task.Run(() => CardReader.ResetDeviceSync(events, cardAction, cancellation));
        ...
        public async Task<ChipPowerResult> ChipPowerAsync(IChipPowerEvents events,
                                                          ...
                                                          CancellationToken cancellation)
            => await Task.Run(() => CardReader.ChipPowerSync(events, action, cancellation));
        ...
        public async Task<ParkCardResult> ParkCardAsync(ParkCardRequest parkCardInfo,
                                                  CancellationToken cancellation)
            => await Task.Run(() => CardReader.ParkCardSync(parkCardInfo, cancellation));
        ...
        public async Task<EMVContactlessConfigureResult> EMVContactlessConfigureAsync(EMVContactlessConfigureRequest terminalConfig, CancellationToken cancellation)
            => await Task.Run(() => CardReader.EMVContactlessConfigureSync(terminalConfig, cancellation));
        ...
        public async Task<EMVContactlessPerformTransactionResult> EMVContactlessPerformTransactionAsync(IEMVClessPerformTransactionEvents events,
                                                                                                        ...
                                                                                                        CancellationToken cancellation)
            => await Task.Run(() => CardReader.EMVContactlessPerformTransactionSync(events, transactionData, cancellation));
        ...
        public async Task<EMVContactlessIssuerUpdateResult> EMVContactlessIssuerUpdateAsync(IEMVClessIssuerUpdateEvents events,
                                                                                            ...
                                                                                            CancellationToken cancellation)
            => await Task.Run(() => CardReader.EMVContactlessIssuerUpdateSync(events, transactionData, cancellation));
        ...
        public async Task<CaptureCardResult> CaptureCardAsync(IRetainCardEvents events,
                                                              CancellationToken cancellation)
            => await Task.Run(() => CardReader.CaptureCardSync(events, cancellation));
        ...
        /// </summary>
        public async Task<ResetCountResult> ResetBinCountAsync(CancellationToken cancellation)
            => await Task.Run(() => CardReader.ResetBinCountSync(cancellation));
        ...
        public async Task<SetCIM86KeyResult> SetCIM86KeyAsync(SetCIM86KeyRequest keyInfo,
                                                        CancellationToken cancellation) 
            => await Task.Run(() => CardReader.SetCIM86KeySync(keyInfo, cancellation));
        ...
        /// </summary>
        public QueryIFMIdentifierResult QueryIFMIdentifier() => CardReader.QueryIFMIdentifier();
        ...
        /// </summary>
        public QueryEMVApplicationResult EMVContactlessQueryApplications() => CardReader.EMVContactlessQueryApplications();

        /// COMMON interface

        public StatusCompletion.PayloadData Status() => Common.Status();

        public CapabilitiesCompletion.PayloadData Capabilities() => Common.Capabilities();

        public async Task<PowerSaveControlCompletion.PayloadData> PowerSaveControl(PowerSaveControlCommand.PayloadData payload) 
            => await Task.Run(() => Common.PowerSaveControl(payload));
        public async Task<SynchronizeCommandCompletion.PayloadData> SynchronizeCommand(SynchronizeCommandCommand.PayloadData payload) 
            => await Task.Run(() => Common.SynchronizeCommand(payload));
        public async Task<SetTransactionStateCompletion.PayloadData> SetTransactionState(SetTransactionStateCommand.PayloadData payload) 
            => await Task.Run(() => Common.SetTransactionState(payload));
        public GetTransactionStateCompletion.PayloadData GetTransactionState() 
            => Common.GetTransactionState();
        public async Task<GetCommandRandomNumberResult> GetCommandRandomNumber() 
            => await Task.Run(() => Common.GetCommandRandomNumber());

        /// <summary>
        /// Specify the type of cardreader
        /// </summary>
        public DeviceTypeEnum DeviceType => CardReader.DeviceType;

        /// <summary>
        /// Specify the current status of media after card is accepted.
        /// </summary>
        public MediaStatusEnum MediaStatus => CardReader.MediaStatus;

        public XFS4IoTServer.IServiceProvider SetServiceProvider
        {
            get => CardReader.SetServiceProvider;
            set => CardReader.SetServiceProvider = value;
        }
    }
}