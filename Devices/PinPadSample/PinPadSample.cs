...
namespace KAL.XFS4IoTSP.PinPad.Sample
{
    ...
    /// </summary>
    public class PinPadSample : IPinPadDevice, IKeyboardDevice, ICryptoDevice, IKeyManagementDevice, ICommonDevice, IGermanDevice
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        private static readonly Dictionary<byte, byte> AsciiToEbcdic = new()
        {
            { 0x00, 0x00 },{ 0x01, 0x01 },{ 0x02, 0x02 },{ 0x03, 0x03 },{ 0x04, 0x1A },{ 0x05, 0x09 },{ 0x06, 0x1A },{ 0x07, 0x7F },
            { 0x08, 0x1A },{ 0x09, 0x1A },{ 0x0A, 0x1A },{ 0x0B, 0x0B },{ 0x0C, 0x0C },{ 0x0D, 0x0D },{ 0x0E, 0x0E },{ 0x0F, 0x0F },
            ...
            { 0x20, 0x40 },{ 0x21, 0x4F },{ 0x22, 0x7F },{ 0x23, 0x7B },{ 0x24, 0x5B },{ 0x25, 0x6C },{ 0x26, 0x50 },{ 0x27, 0x7D },
            { 0x28, 0x4D },{ 0x29, 0x5D },{ 0x2A, 0x5C },{ 0x2B, 0x4E },{ 0x2C, 0x6B },{ 0x2D, 0x60 },{ 0x2E, 0x4B },{ 0x2F, 0x61 },
            { 0x30, 0xF0 },{ 0x31, 0xF1 },{ 0x32, 0xF2 },{ 0x33, 0xF3 },{ 0x34, 0xF4 },{ 0x35, 0xF5 },{ 0x36, 0xF6 },{ 0x37, 0xF7 },
            { 0x38, 0xF8 },{ 0x39, 0xF9 },{ 0x3A, 0x7A },{ 0x3B, 0x5E },{ 0x3C, 0x4C },{ 0x3D, 0x7E },{ 0x3E, 0x6E },{ 0x3F, 0x6F },
            { 0x40, 0x7C },{ 0x41, 0xC1 },{ 0x42, 0xC2 },{ 0x43, 0xC3 },{ 0x44, 0xC4 },{ 0x45, 0xC5 },{ 0x46, 0xC6 },{ 0x47, 0xC7 },
            { 0x48, 0xC8 },{ 0x49, 0xC9 },{ 0x4A, 0xD1 },{ 0x4B, 0xD2 },{ 0x4C, 0xD3 },{ 0x4D, 0xD4 },{ 0x4E, 0xD5 },{ 0x4F, 0xD6 },
            { 0x50, 0xD7 },{ 0x51, 0xD8 },{ 0x52, 0xD9 },{ 0x53, 0xE2 },{ 0x54, 0xE3 },{ 0x55, 0xE4 },{ 0x56, 0xE5 },{ 0x57, 0xE6 },
            { 0x58, 0xE7 },{ 0x59, 0xE8 },{ 0x5A, 0xE9 },{ 0x5B, 0x4A },{ 0x5C, 0xE0 },{ 0x5D, 0x5A },{ 0x5E, 0x5F },{ 0x5F, 0x6D },
            { 0x60, 0x79 },{ 0x61, 0x81 },{ 0x62, 0x82 },{ 0x63, 0x83 },{ 0x64, 0x84 },{ 0x65, 0x85 },{ 0x66, 0x86 },{ 0x67, 0x87 },
            { 0x68, 0x88 },{ 0x69, 0x89 },{ 0x6A, 0x91 },{ 0x6B, 0x92 },{ 0x6C, 0x93 },{ 0x6D, 0x94 },{ 0x6E, 0x95 },{ 0x6F, 0x96 },
            { 0x70, 0x97 },{ 0x71, 0x98 },{ 0x72, 0x99 },{ 0x73, 0xA2 },{ 0x74, 0xA3 },{ 0x75, 0xA4 },{ 0x76, 0xA5 },{ 0x77, 0xA6 },
            { 0x78, 0xA7 },{ 0x79, 0xA8 },{ 0x7A, 0xA9 },{ 0x7B, 0xC0 },{ 0x7C, 0x6A },{ 0x7D, 0xD0 },{ 0x7E, 0xA1 },{ 0x7F, 0x07 },
        ...
        private static readonly Dictionary<byte, byte> EcsdicToAscii = new()
        {
            { 0x00, 0x00 },{ 0x01, 0x01 },{ 0x02, 0x02 },{ 0x03, 0x03 },{ 0x04, 0x1A },{ 0x05, 0x09 },{ 0x06, 0x1A },{ 0x07, 0x7F },
            { 0x08, 0x1A },{ 0x09, 0x1A },{ 0x0A, 0x1A },{ 0x0B, 0x0B },{ 0x0C, 0x0C },{ 0x0D, 0x0D },{ 0x0E, 0x0E },{ 0x0F, 0x0F },
            { 0x10, 0x10 },{ 0x11, 0x11 },{ 0x12, 0x12 },{ 0x13, 0x13 },{ 0x14, 0x1A },{ 0x15, 0x1A },{ 0x16, 0x08 },{ 0x17, 0x1A },
            { 0x18, 0x18 },{ 0x19, 0x19 },{ 0x1A, 0x1A },{ 0x1B, 0x1A },{ 0x1C, 0x1C },{ 0x1D, 0x1D },{ 0x1E, 0x1E },{ 0x1F, 0x1F },
            { 0x20, 0x1A },{ 0x21, 0x1A },{ 0x22, 0x1A },{ 0x23, 0x1A },{ 0x24, 0x1A },{ 0x25, 0x0A },{ 0x26, 0x17 },{ 0x27, 0x1B },
            { 0x28, 0x1A },{ 0x29, 0x1A },{ 0x2A, 0x1A },{ 0x2B, 0x1A },{ 0x2C, 0x1A },{ 0x2D, 0x05 },{ 0x2E, 0x06 },{ 0x2F, 0x07 },
            { 0x30, 0x1A },{ 0x31, 0x1A },{ 0x32, 0x16 },{ 0x33, 0x1A },{ 0x34, 0x1A },{ 0x35, 0x1A },{ 0x36, 0x1A },{ 0x37, 0x04 },
            { 0x38, 0x1A },{ 0x39, 0x1A },{ 0x3A, 0x1A },{ 0x3B, 0x1A },{ 0x3C, 0x14 },{ 0x3D, 0x15 },{ 0x3E, 0x1A },{ 0x3F, 0x1A },
            { 0x40, 0x20 },{ 0x41, 0x1A },{ 0x42, 0x1A },{ 0x43, 0x1A },{ 0x44, 0x1A },{ 0x45, 0x1A },{ 0x46, 0x1A },{ 0x47, 0x1A },
            { 0x48, 0x1A },{ 0x49, 0x1A },{ 0x4A, 0x5B },{ 0x4B, 0x2E },{ 0x4C, 0x3C },{ 0x4D, 0x28 },{ 0x4E, 0x2B },{ 0x4F, 0x21 },
            { 0x50, 0x26 },{ 0x51, 0x1A },{ 0x52, 0x1A },{ 0x53, 0x1A },{ 0x54, 0x1A },{ 0x55, 0x1A },{ 0x56, 0x1A },{ 0x57, 0x1A },
            { 0x58, 0x1A },{ 0x59, 0x1A },{ 0x5A, 0x5D },{ 0x5B, 0x24 },{ 0x5C, 0x2A },{ 0x5D, 0x29 },{ 0x5E, 0x3B },{ 0x5F, 0x5E },
            { 0x60, 0x2D },{ 0x61, 0x1A },{ 0x62, 0x1A },{ 0x63, 0x1A },{ 0x64, 0x1A },{ 0x65, 0x1A },{ 0x66, 0x1A },{ 0x67, 0x1A },
            { 0x68, 0x1A },{ 0x69, 0x1A },{ 0x6A, 0x7C },{ 0x6B, 0x2C },{ 0x6C, 0x25 },{ 0x6D, 0x5F },{ 0x6E, 0x3E },{ 0x6F, 0x3F },
            { 0x70, 0x1A },{ 0x71, 0x1A },{ 0x72, 0x1A },{ 0x73, 0x1A },{ 0x74, 0x1A },{ 0x75, 0x1A },{ 0x76, 0x1A },{ 0x77, 0x1A },
            { 0x78, 0x1A },{ 0x79, 0x60 },{ 0x7A, 0x3A },{ 0x7B, 0x23 },{ 0x7C, 0x40 },{ 0x7D, 0x27 },{ 0x7E, 0x3D },{ 0x7F, 0x22 },
            { 0x80, 0x1A },{ 0x81, 0x61 },{ 0x82, 0x62 },{ 0x83, 0x63 },{ 0x84, 0x64 },{ 0x85, 0x65 },{ 0x86, 0x66 },{ 0x87, 0x67 },
            { 0x88, 0x68 },{ 0x89, 0x69 },{ 0x8A, 0x1A },{ 0x8B, 0x1A },{ 0x8C, 0x1A },{ 0x8D, 0x1A },{ 0x8E, 0x1A },{ 0x8F, 0x1A },
            { 0x90, 0x1A },{ 0x91, 0x6A },{ 0x92, 0x6B },{ 0x93, 0x6C },{ 0x94, 0x6D },{ 0x95, 0x6E },{ 0x96, 0x6F },{ 0x97, 0x70 },
            { 0x98, 0x71 },{ 0x99, 0x72 },{ 0x9A, 0x1A },{ 0x9B, 0x1A },{ 0x9C, 0x1A },{ 0x9D, 0x1A },{ 0x9E, 0x1A },{ 0x9F, 0x1A },
            { 0xA0, 0x1A },{ 0xA1, 0x7E },{ 0xA2, 0x73 },{ 0xA3, 0x74 },{ 0xA4, 0x75 },{ 0xA5, 0x76 },{ 0xA6, 0x77 },{ 0xA7, 0x78 },
            { 0xA8, 0x79 },{ 0xA9, 0x7A },{ 0xAA, 0x1A },{ 0xAB, 0x1A },{ 0xAC, 0x1A },{ 0xAD, 0x1A },{ 0xAE, 0x1A },{ 0xAF, 0x1A },
            ...
            { 0xC0, 0x7B },{ 0xC1, 0x41 },{ 0xC2, 0x42 },{ 0xC3, 0x43 },{ 0xC4, 0x44 },{ 0xC5, 0x45 },{ 0xC6, 0x26 },{ 0xC7, 0x47 },
            { 0xC8, 0x48 },{ 0xC9, 0x49 },{ 0xCA, 0x1A },{ 0xCB, 0x1A },{ 0xCC, 0x1A },{ 0xCD, 0x1A },{ 0xCE, 0x1A },{ 0xCF, 0x1A },
            { 0xD0, 0x7D },{ 0xD1, 0x4A },{ 0xD2, 0x4B },{ 0xD3, 0x4C },{ 0xD4, 0x4D },{ 0xD5, 0x4E },{ 0xD6, 0x4F },{ 0xD7, 0x50 },
            { 0xD8, 0x51 },{ 0xD9, 0x52 },{ 0xDA, 0x1A },{ 0xDB, 0x1A },{ 0xDC, 0x1A },{ 0xDD, 0x1A },{ 0xDE, 0x1A },{ 0xDF, 0x1A },
            { 0xE0, 0x5C },{ 0xE1, 0x1A },{ 0xE2, 0x53 },{ 0xE3, 0x54 },{ 0xE4, 0x55 },{ 0xE5, 0x56 },{ 0xE6, 0x57 },{ 0xE7, 0x58 },
            { 0xE8, 0x59 },{ 0xE9, 0x5A },{ 0xEA, 0x1A },{ 0xEB, 0x1A },{ 0xEC, 0x1A },{ 0xED, 0x1A },{ 0xEE, 0x1A },{ 0xEF, 0x1A },
            { 0xF0, 0x30 },{ 0xF1, 0x31 },{ 0xF2, 0x32 },{ 0xF3, 0x33 },{ 0xF4, 0x34 },{ 0xF5, 0x35 },{ 0xF6, 0x36 },{ 0xF7, 0x37 },
            { 0xF8, 0x38 },{ 0xF9, 0x39 },{ 0xFA, 0x1A },{ 0xFB, 0x1A },{ 0xFC, 0x1A },{ 0xFD, 0x1A },{ 0xFE, 0x1A },{ 0xFF, 0x1A },
        };
        ...
        {
            GetHSMTDataRead hsmTDataRead = new(
                TerminalId: "00054321", 
                BankCode: "00000414", 
                OnlineDateAndTime: "20240919105500", 
                ZAKAId: "K12345P123456789", 
                HSMStatus: GetHSMTDataRead.HSMStatusEnum.Initialized, 
                HSMManufacturerId: "H00099", 
                HSMSerialNumber: "0890001234");
            return Task.FromResult(new GetHSMTDataResponse(MessageHeader.CompletionCodeEnum.Success, hsmTDataRead));
        }
        ...
        /// </summary>
        public async Task<SetHSMTDataResponse> SetHSMTDataAsync(SetHSMTDataRequest request, CancellationToken cancellation)
        {
            await Task.Delay(100);
            return new SetHSMTDataResponse(MessageHeader.CompletionCodeEnum.Success);
        }
        ...
        /// </summary>
        public async Task<SecureMsgSendResponse> SecureMsgSendAsync(SecureMsgSendRequest request, CancellationToken cancellation)
        {
            await Task.Delay(100);
            return new SecureMsgSendResponse(MessageHeader.CompletionCodeEnum.Success, [0x1, 0x2, 0x3, 0x4]);
        }
        ...
        /// state machine.
        /// </summary>
        public async Task<SecureMsgReceiveResponse> SecureMsgReceiveAsync(SecureMsgReceiveRequest request, CancellationToken cancellation)
        {
            await Task.Delay(100);
            return new SecureMsgReceiveResponse(MessageHeader.CompletionCodeEnum.Success);
        }
        ...
        /// </summary>
        public async Task<HSMInitResponse> HSMInitAsync(HSMInitRequest request, CancellationToken cancellation)
        {
            await Task.Delay(100);
            return new HSMInitResponse(MessageHeader.CompletionCodeEnum.Success);
        }
        ...
        public CommonCapabilitiesClass CommonCapabilities { get; set; } = new CommonCapabilitiesClass(
                ...
                GermanInterface: new CommonCapabilitiesClass.GermanInterfaceClass
                (
                    Commands:
                    [
                        CommonCapabilitiesClass.GermanInterfaceClass.CommandEnum.GetHSMTData,
                        CommonCapabilitiesClass.GermanInterfaceClass.CommandEnum.SetHSMTData,
                        CommonCapabilitiesClass.GermanInterfaceClass.CommandEnum.SecureMsgSend,
                        CommonCapabilitiesClass.GermanInterfaceClass.CommandEnum.SecureMsgReceive,
                        CommonCapabilitiesClass.GermanInterfaceClass.CommandEnum.HSMInit,
                    ],
                    Events:
                    [
                        CommonCapabilitiesClass.GermanInterfaceClass.EventEnum.HSMTDataChangedEvent,
                        CommonCapabilitiesClass.GermanInterfaceClass.EventEnum.OPTRequiredEvent,
                    ]
                ),
                DeviceInformation:
                [
