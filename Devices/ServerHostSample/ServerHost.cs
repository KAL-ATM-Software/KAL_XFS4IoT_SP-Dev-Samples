    ...
    class Server
    {
        static async Task Main(/*string[] args*/)
        {
            ...
            try
            {
                ...
                var cardReaderService = new CardReaderServiceProvider(
                    EndpointDetails,
                ...
                var cashDispenserService = new CashDispenserServiceProvider(
                    EndpointDetails,
                ...
                var textTerminalService = new TextTerminalServiceProvider(
                    EndpointDetails,
                ...
                var encryptorService = new CryptoServiceProvider(
                    EndpointDetails,
                ...
                var pinPadService = new PinPadServiceProvider(
                    EndpointDetails,
                ...
                var printerService = new PrinterServiceProvider(
                    EndpointDetails,
                ...
                var lightsService = new LightsServiceProvider(
                    EndpointDetails,
                ...
                var auxService = new AuxiliariesServiceProvider(
                    EndpointDetails,
                ...
                var vendorAppService = new VendorApplicationServiceProvider(
                    EndpointDetails,
                ...
                var vendorModeService = new VendorModeServiceProvider(
                    EndpointDetails,
                ...
                var barcodeReaderService = new BarcodeReaderServiceProvider(
                    EndpointDetails,
                ...
                var biometricService = new BiometricServiceProvider(
                    EndpointDetails,
                ...
                var cashAcceptorService = new CashAcceptorServiceProvider(
                    EndpointDetails,
                ...
                var cameraervice = new CameraServiceProvider(
                    EndpointDetails,
                ...
                */
                ...
                var checkService = new CheckScannerServiceProvider(
                    EndpointDetails,
                ...
                CancellationSource cancelToken = new(Logger);
