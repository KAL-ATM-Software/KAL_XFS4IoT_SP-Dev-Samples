...
namespace KAL::XFS4IoTSP::CardReader::SampleCpp
{
    ...
    /// </summary>
    Task<AcceptCardResult^>^ CardReaderSample::AcceptCardAsync(IAcceptCardEvents^ events, AcceptCardRequest^ acceptCardInfo, CancellationToken cancellation)
    {
        ...
        return Task::FromResult(gcnew AcceptCardResult(MessagePayload::CompletionCodeEnum::Success, nullptr, Nullable<AcceptCardResult::ErrorCodeEnum>()));
    }
    ...
    /// </summary>
    Task<ReadCardResult^>^ CardReaderSample::ReadCardAsync(IReadRawDataEvents^ events, ReadCardRequest^ dataToRead, CancellationToken cancellation)
    {
        ...
        return Task::FromResult(gcnew ReadCardResult(completionCode, readData, chipATR));
    }
    ...
    /// </summary>
    Task<WriteCardResult^>^ CardReaderSample::WriteCardAsync(IWriteRawDataEvents^ events,
                                                      WriteCardRequest^ dataToWrite,
                                                      CancellationToken cancellation)
    {
        Task::Delay(1000, cancellation)->Wait();

        return Task::FromResult(gcnew WriteCardResult(MessagePayload::CompletionCodeEnum::Success, nullptr, Nullable<WriteRawDataCompletion::PayloadData::ErrorCodeEnum>()));
    }
    ...
    /// </summary>
    Task<EjectCardResult^>^ CardReaderSample::EjectCardAsync(EjectCardRequest^ ejectCardInfo,
                                                      CancellationToken cancellation)
    {
        Task::Delay(1000, cancellation)->Wait();
        ...
        return Task::FromResult(gcnew EjectCardResult(MessagePayload::CompletionCodeEnum::Success, nullptr, Nullable<EjectCardCompletion::PayloadData::ErrorCodeEnum>()));
    }
    ...
    /// </summary>
    Task<ChipIOResult^>^ CardReaderSample::ChipIOAsync(ChipIORequest^ dataToSend, CancellationToken cancellation)
    {
        Task::Delay(1000, cancellation)->Wait();
        ...
        chipData->Add(0x90);
        chipData->Add(0x00);
        return Task::FromResult(gcnew ChipIOResult(MessagePayload::CompletionCodeEnum::Success, chipData));
    }
    ...
    /// </summary>
    Task<ResetDeviceResult^>^ CardReaderSample::ResetDeviceAsync(IResetEvents^ events, ResetDeviceRequest^ cardAction, CancellationToken cancellation)
    {
        Task::Delay(1000, cancellation)->Wait();

        MediaStatus = MediaStatusEnum::NotPresent;

        return Task::FromResult(gcnew ResetDeviceResult(MessagePayload::CompletionCodeEnum::Success, nullptr, Nullable<ResetCompletion::PayloadData::ErrorCodeEnum>()));
    }
    ...
    /// </summary>
    Task<ChipPowerResult^>^ CardReaderSample::ChipPowerAsync(IChipPowerEvents^ events, ChipPowerRequest^ action, CancellationToken cancellation)
    {
        Task::Delay(1000, cancellation)->Wait();
        return Task::FromResult(gcnew ChipPowerResult(MessagePayload::CompletionCodeEnum::Success, nullptr, Nullable<ChipPowerCompletion::PayloadData::ErrorCodeEnum>()));
    }
    ...
    /// </summary>
    Task<ParkCardResult^>^ CardReaderSample::ParkCardAsync(ParkCardRequest^ parkCardInfo, CancellationToken cancellation)
    {
        Task::Delay(1000, cancellation)->Wait();
        return Task::FromResult(gcnew ParkCardResult(MessagePayload::CompletionCodeEnum::Success, nullptr, Nullable<ParkCardCompletion::PayloadData::ErrorCodeEnum>()));
    }
    ...
    /// </summary>
    Task<EMVContactlessConfigureResult^>^ CardReaderSample::EMVContactlessConfigureAsync(EMVContactlessConfigureRequest^ terminalConfig, CancellationToken cancellation)
    {
        Task::Delay(1000, cancellation)->Wait();
        return Task::FromResult(gcnew EMVContactlessConfigureResult(MessagePayload::CompletionCodeEnum::Success, nullptr, Nullable<EMVClessConfigureCompletion::PayloadData::ErrorCodeEnum>()));
    }
    ...
    /// </summary>
    Task<EMVContactlessPerformTransactionResult^>^ CardReaderSample::EMVContactlessPerformTransactionAsync(IEMVClessPerformTransactionEvents^ events, EMVContactlessPerformTransactionRequest^ transactionData, CancellationToken cancellation)
    {
        ...
        return Task::FromResult(gcnew EMVContactlessPerformTransactionResult(MessagePayload::CompletionCodeEnum::Success, Result));
    }
    ...
    /// </summary>
    Task<EMVContactlessIssuerUpdateResult^>^ CardReaderSample::EMVContactlessIssuerUpdateAsync(IEMVClessIssuerUpdateEvents^ events, EMVContactlessIssuerUpdateRequest^ transactionData, CancellationToken cancellation)
    {
        Task::Delay(1000, cancellation)->Wait();
        ...
        return Task::FromResult(gcnew EMVContactlessIssuerUpdateResult(MessagePayload::CompletionCodeEnum::Success, txnOutput));
    }
    ...
    /// </summary>
    Task<CaptureCardResult^>^ CardReaderSample::CaptureCardAsync(IRetainCardEvents^ events, CancellationToken cancellation)
    {
        Task::Delay(1000, cancellation)->Wait();
        ...
        return Task::FromResult(gcnew CaptureCardResult(MessagePayload::CompletionCodeEnum::Success,  CapturedCount++, RetainCardCompletion::PayloadData::PositionEnum::Present));
    }
    ...
    /// </summary>
    Task<ResetCountResult^>^ CardReaderSample::ResetBinCountAsync(CancellationToken cancellation)
    {
        // The device doesn't need to talk to the device and return captured count immediately works as a sync
        CapturedCount = 0;
        return Task::FromResult(gcnew ResetCountResult(MessagePayload::CompletionCodeEnum::Success, nullptr));
    }
    ...
    /// </summary>
    Task<SetCIM86KeyResult^>^ CardReaderSample::SetCIM86KeyAsync(SetCIM86KeyRequest^ keyInfo,
                                                    CancellationToken cancellation)
    {
        Task::Delay(1000, cancellation)->Wait();
        return Task::FromResult(gcnew SetCIM86KeyResult(MessagePayload::CompletionCodeEnum::Success, nullptr, Nullable<SetKeyCompletion::PayloadData::ErrorCodeEnum>()));
    }

    /// <summary>
    /// Fires MediaRemovedEvent
    /// </summary>
    void CardReaderSample::FireMediaRemovedEvent(Task^)
    {
        MediaStatus = MediaStatusEnum::NotPresent;
        CardReaderServiceProvider^ cardReaderServiceProvider = dynamic_cast<CardReaderServiceProvider^>(SetServiceProvider);
    ...
    /// <summary>
    /// Helper function to call RunAsync as a continuation of firing the 
    /// media removed event task.
    /// </summary>
    void CardReaderSample::RunAsyncHelper(Task^)
    {
        RunAsync();
    }
    ...
    /// </summary>
    /// <returns></returns>
    Task^ CardReaderSample::RunAsync()
    {
        Contracts::Assert(cardTakenSignal!= nullptr,"");
        return cardTakenSignal->WaitAsync()
               ->ContinueWith(gcnew Action<Task^>(this, &CardReaderSample::FireMediaRemovedEvent))
               ->ContinueWith(gcnew Action<Task^>(this, &CardReaderSample::RunAsyncHelper));
    }
